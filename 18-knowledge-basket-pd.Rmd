...
+--------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Late submissions, accommodations, and extension policy | An extension can be requested up to **48 hours** before the due date through the [extension request form](`r extension`).                              |
|                                                        |                                                                                                                                                              |
|                                                        | In the case of a personal illness/emergency, a [declaration can be made](`r extension`), but must be submitted no more than 3 days after the due date. |
+--------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-   [template.docx](other-files/template.docx)

-   [template.Rmd](other-files/template.Rmd), [template.pdf](other-files/template.pdf), [template_rmd.zip](other-files/template_rmd.zip)
