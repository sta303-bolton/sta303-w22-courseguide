...
Write an \textbf{executive summary} for the case study in your reading this week on Poisson regression, section 4.10 of (Roback \& Legler, 2021): \href{https://bookdown.org/roback/bookdown-BeyondMLR/ch-poissonreg.html\#cs:drinking}{https://bookdown.org/roback/bookdown-BeyondMLR/ch-poissonreg.html\#cs:drinking (Links to an external site.)}.
...
{[}\_\_Register here{]}\_\_(\url{https://forms.office.com/pages/responsepage.aspx?id=JsKqeAMvTUuQN7RtVsVSEO8qoh9ZPflFrDrfXlNN6AdUMVZKSE9BNUpTQThWMVdaUEtCSEFSMUdPMS4u})
