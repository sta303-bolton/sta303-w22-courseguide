...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.66}}
...
Recorded lectures will be linked on the \protect\hyperlink{overview}{Course overview} page. I aim to have the links up within 24 hours of class. They take some time to process.
