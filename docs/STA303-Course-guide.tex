...
You can access the template for this assessment \href{https://jupyter.utoronto.ca/hub/user-redirect/git-pull?repo=https\%3A\%2F\%2Fgithub.com\%2Fsta303-bolton\%2Fsta303-w22-portfolio\&urlpath=rstudio\%2F\&branch=master}{here}. {[}COMING SOON{]}
...
\item
  {[}Super super optional{]} Post your character on the \href{https://q.utoronto.ca/courses/204826/discussion_topics/1061843?module_item_id=2273817}{optional discussion board for this week}. If you have a Stardew Valley character or some other pixel art of yourself, you can share that, too. This is just for fun, no requirement to participate. Please be sensible about making sure any images are \emph{appropriate.} Don't use images of other people, etc.
\end{enumerate}
...
\begin{figure}
\centering
\includegraphics{STA303-Course-guide_files/figure-latex/unnamed-chunk-67-1.pdf}
\caption{\label{fig:unnamed-chunk-67}\emph{Figure: Visual representation of the equation for this data}}
\end{figure}
...
\includegraphics{STA303-Course-guide_files/figure-latex/unnamed-chunk-75-1.pdf}
...
\subsubsection{Model formula}\label{model-formula}}
...
\subsection{Model formula}\label{model-formula-1}}
...
\vtop{\hbox{\strut There will also be a \href{https://q.utoronto.ca/courses/253305/pages/office-hours}{\textbf{TA office hour tomorrow from noon to 1:00 p.m.}} (and one at 5, but that is after the due time, which is, of course, 3:03 p.m. ET on \href{https://markus-ds.teach.cs.toronto.edu/courses}{MarkUs~(Links to an external site.)}).}\hbox{\strut Please make sure you're \textbf{knitting early and often} and have checked out some of the Piazza posts I highlighted as \textbf{\emph{very helpful}} in \href{https://q.utoronto.ca/courses/253305/discussion_topics/1605315}{this announcement}. Test out your \textbf{access to \href{https://markus-ds.teach.cs.toronto.edu/courses}{MarkUs~(Links to an external site.)}} and upload as many times as you like before the deadline.}}
