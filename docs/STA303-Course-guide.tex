...
\textbf{Piazza} will be available until the start of the window. You may asked questions about the untimed component of the mini-mixed assessment, using the mini-mixed assessment tag.

\textbf{Tech office hours} will take the place of our usualclass time on Wednesday. Use the usual link to join. Content questions will not be answered, but I recommend you aim to complete the timed component before/during there times as then I can provided timely assistance if there are any issues.
