...
You can get a more visual PDF version of the syllabus [here]("https://github.com/sta303-bolton/sta303-w22-courseguide/raw/master/other-files/STA303-1002_W22_syllabus.pdf"). This version is hopefully better suited to searching and screen readers.
...
Any request to have an assessment remarked must be submitted to [the appropriate form](https://q.utoronto.ca/courses/253305/pages/forms) on the Forms page on Quercus under the following conditions:
